          ...
          <Row className={styles.rowInfo} lg={3} xs={1}>
            <Col className={styles.info}>
              ...
              <p>
                ...
                +Salud. Dale clic al botón. <Link to="/login">registrarse</Link>{" "}
                y
              </p>
            </Col>
            <Col className={styles.info}>
              ...
              <p>
                Al ingresar verás casilleros vacíos en donde completaras tu
            ...
            <Col className={styles.info}>
              ...
              <p>
                +Salud, ideó una aplicación para que cada vez que visites un
                profesional, este mismo pueda cargar tu atención de manera
                fácil.
              </p>
            </Col>
          </Row>
